		               				...
		               				<th>Book Name</th>
		               				 ...
		               				 <input class="form-control" type="text" name="bname" id="bname" value=<%=rs2.getString("book_name") %> disabled>
		               				  <input type="hidden" name="filename" id="filename" value=<%=rs2.getString("file") %> >
		               				   <input type="hidden" name="price" id="price" value=<%=rs2.getString("price") %> >
		               				 </td>
		               			</tr>		               			
		               			<tr>
		               				<th>Price</th>
		               				<td><input class="form-control" type="text" name="bprice" id="bprice" value=<%=rs2.getString("price") %> disabled></td>
		               			</tr>
...
<script>
console.log("Hello");
console.log(document.getElementById("bprice").value);
